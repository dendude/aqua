...
<div class="row">
    <div class="col-xs-12 col-md-10 col-lg-8">
        ...
        <div class="well">
            <?= $form->field($model, 'section_id', $inputMiddle)->dropDownList(\app\models\NewsSections::getFilterList()) ?>
            ...
            <div class="separator"></div>
            <?= $form->field($model, 'is_slider')->checkbox(['label' => 'Добавить в слайдер новостей']) ?>
