...
class ActionsSections extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function getActions() {
        return $this->hasMany(Actions::className(), ['section_id' => 'id'])->orderBy('ordering ASC, id DESC');
    }
