...
class News extends \yii\db\ActiveRecord
{
    ...
    public function getBreadcrumbs() {
        ...
        $news = Pages::findOne(self::PAGE_ID);

        $breadcrumbs[] = ['url' => Url::to([Normalize::fixAlias($news->alias)]),
                        'label' => $news->crumb];

        $breadcrumbs[] = ['url' => Url::to([$news->alias, 'section' => $this->section->id]),
    ...
    public function attributeLabels()
    {
        return [
            ...
            'manager_id' => 'Менеджер',
            'section_id' => 'Раздел',
            'menu_title' => 'Название в виджетах',
            'photo' => 'Фото',
            'title' => 'Заголовок (Н1)',
            'alias' => 'Alias (URL)',
